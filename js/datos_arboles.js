...
✨ <strong>Curiosidad que genera asombro</strong>: ¿Sabías que mis vainas con forma de oreja tienen un súper poder? Contienen saponinas —una sustancia tan jabonosa que los llaneros de antes lavaban su ropa restregando mis vainas verdes contra la tela sin necesitar jabón. ¡Soy el árbol que hace espuma! Y si eso no fuera poco, mis semillas son tan duras que pueden sobrevivir dentro de la barriga de un caballo y germinar en el otro extremo del llano. 🐎🌱`,
    ...
    // ─────────────────────────────────────────────────────────────
    // 🌳 MEREcURE (Moquilea pyrifolia / Licania pyrifolia) — JBP-19
    // ─────────────────────────────────────────────────────────────
    {
        id: "#JBP-19",
        nombreCientifico: "Moquilea pyrifolia (Griseb.) R.O.Williams",
        sinonimos: "Licania pyrifolia Griseb. (nombre aceptado en Flora de Colombia); Moquilea macrocarpa Pittier (1938)",
        familia: "Chrysobalanaceae",
        nombresLocales: ["Merecure", "Querebere", "Árbol del Llano", "Merecure plateado"],
        origen: "Nativo",
        estadoConservacion: "LC — Preocupación Menor (no evaluada formalmente por UICN; no figura en Libros Rojos de Colombia)",
        descripcionGeneral: "Árbol pequeño a mediano (8–15 m de altura, hasta 45 cm DAP), perennifolio (siempre verde), de copa globosa o redondeada muy frondosa y densa. Tronco corto con ramas expandidas. Hojas simples, alternas, elípticas a oblongas (4.5–11 cm × 2–5.5 cm), semejantes a las del peral (de ahí el epíteto 'pyrifolia'). Flores blancas, pequeñas (4–4.5 mm), fragantes, hermafroditas. Fruto oblongo tipo drupa (hasta 11 cm × 5 cm), epicarpo verrugoso, pericarpo grueso y fibroso, pulpa amarillo-cremosa de sabor agradable. Madera pesada, dura, fuerte y duradera, con vetas de goma rojiza. Especie de crecimiento lento y vida muy larga, símbolo natural del estado Apure (Venezuela).",
        distribucion: "Nativa del Neotrópico: islas del Caribe (Trinidad, Martinica), Venezuela (cuencas del Orinoco y Apure), Colombia (Arauca, Casanare, Meta). En Colombia registrada entre 0–400 m s.n.m. en bosques de tierras bajas, bosques ribereños y lugares abiertos de la Orinoquía. Presencia confirmada en Maní, Casanare, mediante colecciones de herbario (García-Barriga et al. 18528, 1965, Orocué, río Meta).",
        taxonomiaHTML: `
            <div class="tax-table">
                <div class="tax-row"><span class="tax-label">Reino</span><span class="tax-val">Plantae</span></div>
                <div class="tax-row"><span class="tax-label">División</span><span class="tax-val">Magnoliophyta (Angiospermas)</span></div>
                <div class="tax-row"><span class="tax-label">Clase</span><span class="tax-val">Magnoliopsida (Dicotiledóneas)</span></div>
                <div class="tax-row"><span class="tax-label">Orden</span><span class="tax-val">Malpighiales</span></div>
                <div class="tax-row"><span class="tax-label">Familia</span><span class="tax-val">Chrysobalanaceae R.Br.</span></div>
                <div class="tax-row"><span class="tax-label">Género</span><span class="tax-val"><em>Moquilea</em> Aubl. / <em>Licania</em> Aubl.</span></div>
                <div class="tax-row"><span class="tax-label">Especie</span><span class="tax-val"><em>Moquilea pyrifolia</em> (Griseb.) R.O.Williams (1932)</span></div>
                <div class="tax-row"><span class="tax-label">Autoría original</span><span class="tax-val">August Heinrich Rudolf Grisebach — <em>Licania pyrifolia</em> Griseb., Fl. Brit. W. Ind. 230. 1860</span></div>
                <div class="tax-row"><span class="tax-label">Origen biogeográfico</span><span class="tax-val">Neotrópico: Caribe (Trinidad, Martinica), Venezuela, Colombia (Orinoquía)</span></div>
                <div class="tax-row"><span class="tax-label">Nota nomenclatural</span><span class="tax-val">El género <em>Licania</em> fue reconocido como polifilético; el subgénero <em>Moquilea</em> se segregó como género independiente. Para Flora de Colombia (Biovirtual UNAL), el nombre aceptado vigente es <em>Licania pyrifolia</em> Griseb.</span></div>
            </div>
        `,
        etimologia: `<strong>Mocuilea</strong>: posiblemente derivado de un nombre vernáculo indígena caribeño para especies de este género.<br><strong>pyrifolia</strong>: del latín <em>pyrus</em> (peral, árbol de pera) + <em>folium</em> (hoja) → "con hojas semejantes a las del peral", aludiendo a la forma elíptica y ápice agudo de sus hojas que recuerdan a las de <em>Pyrus</em> spp.`,
        datosCuriosos: [
            "🎵 <strong>¡El único árbol con su propio golpe de joropo!</strong> El compositor Pedro Francisco Vivas creó el ritmo 'Merecure' (1900–1910) inspirado en este árbol. René Devia canta: 'El canto de los petises siempre me hace recordar, el merecure plateado, las flores del morichal'.",
            "🇻🇪 <strong>Símbolo natural del estado Apure (Venezuela)</strong>, evidenciando su importancia emblemática en los Llanos colombo-venezolanos.",
            "👶 <strong>Dicho popular llanero</strong>: 'Conmigo es: palos pa' lo alto, merecures pa'l suelo y chinos a recoger' —refiriéndose a que los niños recogen los frutos caídos como si fueran mangos.",
            "🌳 <strong>Copa legendaria</strong>: Según el botánico Adolfo Ernst (1832–1899), bajo la copa de un merecure adulto pueden pastar hasta 200 reses.",
            "🥛 <strong>Fruto versátil</strong>: Se consume fresco, en jugos, dulces, helados, chicha, y troceado mezclado con leche como laxante suave."
        ],
        biometria: {
            altura: "8–15 m (hasta 22 m en óptimas condiciones)",
            dap: "Hasta 45 cm (tronco generalmente corto)",
            copa: "Globosa o redondeada, 6–12 m de diámetro, muy frondosa y densa",
            longevidad: "Especie de crecimiento lento y vida muy larga (décadas a siglos)",
            densidadMadera: "⚠️ Por verificar en campo — Literatura sugiere rango probable 0.65–0.80 g/cm³ (madera descrita como 'pesada, dura, fuerte y duradera', con vetas de goma rojiza). Especie próxima <em>Licania campestre</em> reporta 0.60 g/cm³.",
            carbonParams: "Fracción carbono: 0.47–0.50 (IPCC para bosque tropical) | FEB: ⚠️ Por verificar | Factor CO₂: × 3.667"
        },
        ecuacionAlometrica: `
<strong>Ecuación multiespecie para bosques naturales de Colombia (Álvarez et al., 2012):</strong>
<pre style="background:#f8f9fa;padding:12px;border-radius:6px;margin:10px 0;font-size:0.85rem;">BA = a × ρ × DAP^b × H^c

Donde:
  • BA  = Biomasa aérea (kg árbol⁻¹)
  • ρ   = Densidad básica de la madera (g/cm³) → ⚠️ Dato por verificar en campo (usar 0.65–0.80 como referencia provisional)
  • DAP = Diámetro a la Altura del Pecho (cm), medido a 1.30 m
  • H   = Altura total del árbol (m)
  • a, b, c = Coeficientes ajustados para bosques naturales de Colombia (ver Álvarez et al., 2012, Tabla 2)

── Estimación de Carbono ──────────────────────────────────────
Carbono árbol (kg C)    = BA × 0.47–0.50
CO₂ equiv. (kg CO₂eq)  = Carbono × 3.667
Carbono total rodal (t) = Σ BA × 0.47 / 1000</pre>
<strong>Fuente:</strong> Álvarez, E., Duque, A., Saldarriaga, J. G., Cabrera, K., De las Salas, G., Del Valle, J. I., Moreno, F., Orrego, S. A., & Rodríguez, L. (2012). Tree above-ground biomass allometries for carbon stocks estimation in the natural forests of Colombia. <em>Forest Ecology and Management, 267</em>, 297–308. https://doi.org/10.1016/j.foreco.2011.11.013

⚠️ <strong>Nota técnica:</strong> No existe ecuación alométrica especie-específica validada para <em>Moquilea pyrifolia</em> en sabanas inundables del Casanare. El modelo de Álvarez et al. (2012) es la opción técnicamente más sólida disponible para Colombia.`,
        bloqueTecnico: `
<blockquote style="border-left:4px solid #6B8E23;padding:12px 16px;margin:16px 0;background:#f9fff5;font-style:italic;">
"<strong>La estimación de los contenidos y flujos de carbono en bosques tropicales es, en la actualidad, uno de los principales temas de interés científico, debido a que estos ecosistemas actúan como verdaderos sumideros o fuentes de dióxido de carbono (CO₂) a la atmósfera, especialmente cuando la deforestación tropical ha contribuido con aproximadamente el 20% de las emisiones globales de Gases de Efecto Invernadero (GEI) en las últimas décadas. En Colombia, el IDEAM publicó en 2011 el Mapa de Carbono Forestal Biomasa Aérea, generado en 3.499 levantamientos florísticos e inventarios forestales en 838 hectáreas durante el periodo 1990–2010, presentando los resultados de estimación de las reservas potenciales de carbono almacenado en la biomasa aérea de los bosques naturales del país, de acuerdo a lo establecido por el IPCC (2006).</strong>"
<br><br><strong>— Yepes, A. P., Navarrete, D. A., Duque, A. J., Phillips, J. F., Cabrera, K. R., Álvarez, E., García, M. C., & Ordóñez, M. F. (2011).</strong> <em>Protocolo para la estimación nacional y subnacional de biomasa-carbono en Colombia</em> (pp. 1–2). Instituto de Hidrología, Meteorología y Estudios Ambientales – IDEAM.
</blockquote>`,
        fenologia: [
            { mes: "Ene", evento: "☀️ Verano — Floración", icono: "🌸" },
            { mes: "Feb", evento: "☀️ Verano — Floración", icono: "🌸" },
            { mes: "Mar", evento: "☀️ Verano — Inicio fructificación", icono: "🌱" },
            { mes: "Abr", evento: "🌧️ Inicio lluvias — Fructificación temprana", icono: "💧" },
            { mes: "May", evento: "🌧️ Lluvias — Frutos inmaduros", icono: "🍑" },
            { mes: "Jun", evento: "🌧️ Lluvias — Desarrollo frutos", icono: "🍑" },
            { mes: "Jul", evento: "🌧️ Invierno — Maduración frutos", icono: "🟠" },
            { mes: "Ago", evento: "🌧️ Invierno — Máxima fructificación", icono: "🟠" },
            { mes: "Sep", evento: "🌧️ Lluvias — Dispersión semillas", icono: "🐦" },
            { mes: "Oct", evento: "🌤️ Transición — Vegetación activa", icono: "🌿" },
            { mes: "Nov", evento: "🌤️ Transición — Follaje denso", icono: "🌿" },
            { mes: "Dic", evento: "☀️ Verano — Perennifolio", icono: "🌳" }
        ],
        morfologia: `
            <div class="grid2 mt-3" style="font-size:0.9rem;">
                <div class="metric-card"><div class="metric-label">🏛️ Hábito General</div><div class="section-val text-sm mt-2">Árbol pequeño a mediano (8–15 m), perennifolio (siempre verde), copa globosa o redondeada muy frondosa. Ramas expandidas, pubescentes en juventud, glabras al madurar. Tronco corto. Sistema radicular profundo que le confiere resistencia a fluctuación hídrica de los llanos.</div></div>
                <div class="metric-card"><div class="metric-label">🌱 Raíz</div><div class="section-val text-sm mt-2">Raíz principal pivotante de penetración profunda, complementada por raíces laterales extendidas que permiten captación de agua y nutrientes en suelos de sabana inundable. No presenta raíces tabulares o zancudas.</div></div>
                <div class="metric-card"><div class="metric-label">🪵 Tallo / Corteza</div><div class="section-val text-sm mt-2">Madera marrón claro o rosado grisáceo, oscurece con exposición ambiental. Vetas de goma marrón rojizo oscuro, largas, anchas y prominentes. Pesada, dura, fuerte y duradera. Corteza externa con lenticelas inconspicuas.</div></div>
                <div class="metric-card"><div class="metric-label">🍃 Hojas</div><div class="section-val text-sm mt-2">Simples, alternas, disposición espiralada. Lámina elíptica a oblonga (4.5–11 × 2–5.5 cm), base redondeada, ápice agudo a abruptamente apiculado. Vena media plana en haz, lanosa en envés; 6–8 pares venas primarias. Pecíolo 8–16 mm. Estípulas caducas, lineares, membranáceas. Epíteto <em>pyrifolia</em> = "hojas de peral".</div></div>
                <div class="metric-card"><div class="metric-label">🌸 Flores</div><div class="section-val text-sm mt-2">Hermafroditas, pequeñas (4–4.5 mm), blancas, fragantes. Solitarias o en pequeños grupos sobre ramas cortas. 5 pétalos (2–4 mm), glabros, ciliados en márgenes. Cáliz con lóbulos agudos, tomentosos por fuera. 25–35 estambres, filamentos libres más largos que lóbulos del cáliz. Ovario lanoso; estilo hirsuto casi hasta el ápice.</div></div>
                <div class="metric-card"><div class="metric-label">🍑 Frutos</div><div class="section-val text-sm mt-2">Drupa oblonga (hasta 11 × 5 cm), epicarpo densamente verrugoso y glabro, pericarpo grueso, frágil, fibroso. Color verde grisáceo con manchas blancas o marrón grisáceo al madurar. Una sola semilla grande. Pulpa amarillo-cremosa, algo fibrosa, sabor agradable, olor fuerte en madurez.</div></div>
                <div class="metric-card"><div class="metric-label">🌱 Propagación</div><div class="section-val text-sm mt-2">Principalmente por semillas. También puede reproducirse por esquejes de ramas jóvenes (menos común). Crecimiento lento, vida muy larga. Germinación inicia a la semana tras escarificación con agua hervida (5 min); 84% germinación; ~1.400 semillas/kg.</div></div>
            </div>
        `,
        faunaAsociada: `
            <div class="grid3 mt-3" style="font-size:0.85rem;">
                <div class="metric-card"><div class="metric-label">🐦 Aves</div><div class="section-val text-sm mt-2"><strong>Aves llaneras, cotorras (<em>Psittacidae</em>), carpinteros (<em>Picidae</em>):</strong> Copa densa usada como sitio de percha, nidificación y forrajeo. Frutos carnosos consumidos por aves frugívoras.</div></div>
                <div class="metric-card"><div class="metric-label">🐄🦌 Mamíferos</div><div class="section-val text-sm mt-2"><strong>Ganado bovino, chigüiro (<em>Hydrochoerus hydrochaeris</em>), báquiro (<em>Pecari tajacu</em>), venado (<em>Odocoileus virginianus</em>), roedores:</strong> Frutos caídos constituyen alimento importante. Cháchaco/pecarí y ganado consumen frutos con avidez.</div></div>
                <div class="metric-card"><div class="metric-label">🐝🦋 Insectos</div><div class="section-val text-sm mt-2"><strong>Abejas (<em>Apis mellifera</em>, meliponinos), mariposas, polinizadores:</strong> Flores blancas y fragantes atraen insectos polinizadores, contribuyendo a polinización cruzada en paisaje llanero.</div></div>
            </div>
        `,
        usos: `
            <div class="grid2 mt-3" style="font-size:0.9rem;">
                <div class="metric-card"><div class="metric-label">🪵 Carpintería y Construcción Rural</div><div class="section-val text-sm mt-2">Madera pesada, dura, fuerte y duradera. Se divide fácilmente, toma pulido suave y lustroso. Usada para horcones, columnas, estantes, postes, mangos de herramientas, pilones, tabiques (saladeros de ganado). Alta durabilidad natural en contacto con agua (construcción de canoas, bongos).</div></div>
                <div class="metric-card"><div class="metric-label">🌳 Sombra y Silvopastoreo</div><div class="section-val text-sm mt-2">Históricamente plantado cerca de viviendas y en potreros como árbol de sombra. Copa redondeada y perennifolia proporciona frescura permanente. Ideal para sistema silvopastoril llanero, reduce estrés calórico del ganado en verano. Ornamento en parques, plazas y avenidas amplias.</div></div>
                <div class="metric-card"><div class="metric-label">🍎 Fruto Comestible y Forrajero</div><div class="section-val text-sm mt-2">Pulpa harinosa comestible, sabor agradable. Consumo humano: fresco, jugos, dulces, helados, chicha. Comunidades indígenas Pumé y Guahibos elaboraban harina para bebidas. Ganado y fauna silvestre consumen frutos ávidamente. Principal forrajero de los llanos.</div></div>
                <div class="metric-card"><div class="metric-label">🌿 Usos Medicinales y Fitoquímicos</div><div class="section-val text-sm mt-2">Corteza con aplicaciones en medicina popular llanera. Compuestos bioactivos confirman actividad moluscicida contra caracoles dañinos (Braca et al., 2003). Familia Chrysobalanaceae rica en fenólicos, triterpenos y flavonoides con potencial farmacológico. Fruto usado como laxante suave; consumo troceado con leche.</div></div>
                <div class="metric-card"><div class="metric-label">🧼 Curtiembre y Artesanías</div><div class="section-val text-sm mt-2">Corteza rica en taninos: mezclada con agua y sal en tabiques de madera del mismo árbol para curtir tejidos. Exudado del tronco tiene propiedades similares a goma arábiga (adhesivo artesanal). Aserrín funciona como barbasco (ictiotoxico para pesca tradicional).</div></div>
                <div class="metric-card"><div class="metric-label">🎵 Valor Cultural Inmaterial</div><div class="section-val text-sm mt-2">Nombre "Merecure" inspira golpe del joropo llanero creado por Pedro Francisco Vivas (1900–1910). René Devia compone "Los merecures": 'El canto de los petises siempre me hace recordar, el merecure plateado, las flores del morichal'. Árbol emblemático de tradición oral llanera.</div></div>
            </div>
        `,
        mensajeIA: `🌳 <strong>Soy el Merecure... y tengo un secreto que te va a sorprender</strong>
...
✨ <strong>Curiosidad que genera asombro</strong>: ¿Sabías que bajo mi copa pueden pastar hasta 200 reses al mismo tiempo? Así lo dijo el botánico Adolfo Ernst hace más de cien años. Y si eso no fuera poco, mis frutos caídos son tan apetitosos que los niños llaneros corren a recogerlos como si fueran mangos, y el dicho popular reza: "palos pa' lo alto, merecures pa'l suelo y chinos a recoger". ¡Soy el árbol que alimenta, da sombra y además tiene su propia música! 🎵🌱`,
        referencias: [
            "Álvarez, E., Duque, A., Saldarriaga, J. G., Cabrera, K., De las Salas, G., Del Valle, J. I., Moreno, F., Orrego, S. A., & Rodríguez, L. (2012). Tree above-ground biomass allometries for carbon stocks estimation in the natural forests of Colombia. Forest Ecology and Management, 267, 297–308. https://doi.org/10.1016/j.foreco.2011.11.013",
            "Braca, A., Bilia, A. R., Mendez, J., Pizza, C., Morelli, I., & De Tommasi, N. (2003). Chemical and biological studies on Licania genus. En Studies in Natural Products Chemistry (Vol. 28, pp. 35–67). Elsevier. https://doi.org/10.1016/S1572-5995(03)80004-3",
            "Forero, E., & Romero, C. (Eds.). (1990). Flora de Colombia: Chrysobalanaceae. Instituto de Ciencias Naturales, Universidad Nacional de Colombia; ICFES. http://www.biovirtual.unal.edu.co/floradecolombia/es/description/795/",
            "Hoyos F., J. (1983). Guía de árboles de Venezuela (Monografía N° 32, pp. 282–283). Fundación La Salle de Ciencias Naturales.",
            "Prance, G. T., & Sothers, C. A. (2003). Chrysobalanaceae 1, Chrysobalanus to Parinari. Species Plantarum: Flora of the World, Part 9 (pp. 1–319). Australian Biological Resources Study.",
            "Sothers, C. A., Prance, G. T., & Chase, M. W. (2019). A new name in Moquilea (Chrysobalanaceae). Kew Bulletin, 74(4), 58. https://doi.org/10.1007/s12225-019-9835-0",
            "Yepes, A. P., Navarrete, D. A., Duque, A. J., Phillips, J. F., Cabrera, K. R., Álvarez, E., García, M. C., & Ordóñez, M. F. (2011). Protocolo para la estimación nacional y subnacional de biomasa-carbono en Colombia. IDEAM.",
            ...
            "Universidad Nacional de Colombia – Biovirtual. (s.f.). Licania pyrifolia. Flora de Colombia. Instituto de Ciencias Naturales, UNAL.",
            "Acero Duarte, L. E. (2005). Plantas útiles de la cuenca del Orinoco. BP Exploration Company (Colombia) Limited; Ecopetrol; Corporinoquia."
        ],
        quiz: [
            { q: "¿A qué familia botánica pertenece el Merecure (Moquilea pyrifolia)?", opts: ["Fabaceae (leguminosas)", "Moraceae (moreras y ficus)", "Chrysobalanaceae", "Myrtaceae (guayabos y arrayanes)"], correct: 2 },
            { q: "¿Cuál de las siguientes afirmaciones sobre la madera del Merecure es CORRECTA según la descripción de la especie?", opts: ["La madera es liviana, blanda y de fácil deterioro", "La madera es de crecimiento rápido y color blanco brillante", "La madera es pesada, dura, fuerte y duradera, con vetas de goma rojiza, usada en carpintería rural para horcones y estantes", "La madera no tiene ningún uso porque es tóxica"], correct: 2 },
            { q: "¿Por qué el Merecure es especialmente valioso para la fauna silvestre y el ganado de los llanos de Casanare?", opts: ["Porque sus raíces producen miel que consumen las abejas", "Porque sus flores son tan grandes que sirven de refugio para aves rapaces", "Porque es un árbol siempre verde (perennifolio) cuya copa densa da sombra permanente y cuyos frutos carnosos son fuente de alimento para el ganado, mamíferos silvestres y aves durante todo el año", "Porque atrae lluvia con sus hojas y por eso se planta en los cultivos"], correct: 2 },
            { q: "¿Qué hecho cultural único distingue al Merecure de otros árboles colombianos?", opts: ["Es el árbol nacional de Colombia desde 1959", "Su nombre inspiró un golpe del joropo llanero creado por Pedro Francisco Vivas (1900–1910)", "Sus hojas se usan para tejer sombreros vueltiaos", "Su madera se usa exclusivamente para fabricar arpas llaneras"], correct: 1 }
        ]
    }
};
